...
import com.example.RateLimiterApplication.Config.RateLimiterProperties;
...
//        return decremented >= 0;
    ...
    public void refillTokens(String clientId, Jedis jedis) {
        ...
        // Bucket hamesha capacity se start karega, kabhi 0 se nahi.
...
//        }
        ...
        long tokensToAdd = (elapsedTime * properties.getRefillRate()) / 10000;
        if(tokensToAdd <= 0) {
            return;
        }
